...
FileInputStream fin=new FileInputStream("C:/WorkSpace/FileInput/ICP-Billing/programStatus2.txt");
...
window.onload = timedRefresh(30*1000);
<%}%>
...
%>
					...
					<font color="orange">Program is running - Please do nothing
						(Screen will auto refresh for every 1 minute)</font><br>
					...
					<table style="margin: 0px auto; width: 500px" align="left" border=0>
						...
						<tr>
							<td colspan="4" align="left"><b>Left to bill </b><br> <textarea
									id="outputText" rows=20 cols=75 wrap=on readonly
									style="color: white; background-color: black">
									<%
									for (Iterator it = invOutput.iterator(); it.hasNext();)
									{out.println(it.next());}
									%>
	</textarea> <br></td>
						</tr>
...
%>
					...
					<form action="CheckBillBalanceServlet" method="POST">
