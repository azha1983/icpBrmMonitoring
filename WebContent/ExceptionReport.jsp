		...
		<div id="content">
			<div id="content-inner">
				...
				<div class="article">
					...
					<p id="dateC"></p>
					<p>
					<h2>ICP BRM Exception daily list</h2>
					<%if(request.getParameter("resultReturn") == null) 
{%>

					<font color="orange">To generate ICP-BRM Daily list</font>


					<form action="ICPExceptionGenReportServlet" method="POST"  onsubmit="myButton.disabled = true; return true;">

						<table border=0>
							<tr>
								<td>Username</td>
								<td>:</td>
								<td><input type="text" name="eaiID" size=10 value="S53725"></td>

							</tr>
							<tr>
								<td>Password</td>
								<td>:</td>
								<td><input type="text" name="eaiID" size=10></td>
							</tr>
							<tr>
								<td colspan="4" align="center" bgcolor="#f9ebdb"><input
									type="submit" value="Generate" name="myButton"></td>
							</tr>
						</table>
...
{%>
					...
					<form action="ICPExceptionGenReportServlet" method="POST">
