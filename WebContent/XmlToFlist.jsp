	...
	<div id="page">
		...
		<div id="content">
			<div id="content-inner">
				...
				<div class="article">
					<p>
					<h2>XML to FList Converter</h2>

					<%if(request.getParameter("resultFlist") == null) 
{%>
					<form action="XmlToFlistServlet" method="POST">
						<table border=1 style="margin: 0px auto; width: 500px">
							...
							<tr>
								<td><textarea id="outputText" name="xmlValue" rows=13
										cols=100 wrap=on></textarea></td>


							</tr>
							<tr>
								<td colspan="2" align="center" bgcolor="#f9ebdb"><input
									type="submit" value="Convert"></td>
							</tr>
						</table>
...
{%>
					<form action="XmlToFlistServlet" method="POST">
						<table border=1 style="margin: 0px auto; width: 500px">
							...
							<tr>
								<td><textarea id="outputText" name="xmlValue" rows=13
										cols=100 wrap=on><%=request.getParameter("resultFlist")%></textarea></td>
