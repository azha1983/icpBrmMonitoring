		...
		<div id="content">
			<div id="content-inner">
				...
				<div class="article">
					...
					<p id="dateC"></p>
					<p>
					<h2>Total Account to be Invoice - Each BP</h2>
<% if(request.getParameter("bpSent") == null)
	{%>
<form action=" ../CheckTotalInvBPServlet" method="POST">
					Please enter date :
									&nbsp;&nbsp;&nbsp;&nbsp; <select name="month">
...
<%
		...
		Vector  vc = (Vector)session.getAttribute("objetBPInv");
					...
					<br>
					 <table width=100% border=1>
					  <tr align=center bgcolor="#f9ebdb">
					    <th>BP</th>
					    <th>Total Invoice - <%=request.getParameter("monthcheck") %></th>
					  </tr>
					  <%
					  int y = 1;
					  String str = "Null";
